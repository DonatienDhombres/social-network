...
router.put('/experience', [auth,
    ...
    async (req, res) => {
        ...
        try {
            ...
            //unshift is like push, but add at the beginning, because profile.experience is an array
            await profile.save();
...
router.put('/education', [auth,
    ...
    async (req, res) => {
        ...
        try {
            ...
            //unshift is like push, but add at the beginning, because profile.education is an array
            await profile.save();
